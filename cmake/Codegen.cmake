...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE_FOUND)
    if(CXX_SVE128_FOUND)
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_SVE_CPU_DEFINITION -DHAVE_SVE128_CPU_DEFINITION")
      list(APPEND CPU_CAPABILITY_NAMES "SVE128")
      if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=128")
      else()
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=128")
      endif()
    endif(CXX_SVE128_FOUND)
    ...
    if(CXX_SVE512_FOUND)
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_SVE_CPU_DEFINITION -DHAVE_SVE512_CPU_DEFINITION")
      list(APPEND CPU_CAPABILITY_NAMES "SVE512")
      if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=512")
      else()
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=512")
      endif()
    endif(CXX_SVE512_FOUND)
  endif(CXX_SVE_FOUND)
