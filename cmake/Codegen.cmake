...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(COMPILER_HAS_ARM_SVE)
    ...
    LIST(APPEND SVE_SUPPORT_BITS "128" "256" "512")
    foreach(BITS ${SVE_SUPPORT_BITS})
      SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_SVE${BITS}_CPU_DEFINITION")
      LIST(APPEND CPU_CAPABILITY_NAMES "SVE${BITS}")
      ...
      if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        LIST(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=${BITS}")
      else()
        LIST(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=${BITS}")
      endif()
    endforeach()
