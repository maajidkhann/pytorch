  ...
  if(CXX_SVE_FOUND)
    ...
    foreach(VLEN IN ITEMS 128 256 512)
        ...
        if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
            list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.2-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=${VLEN}")
        else()
            list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.2-a+sve -DCPU_CAPABILITY_SVE -msve-vector-bits=${VLEN}")
        endif()
    endforeach()
